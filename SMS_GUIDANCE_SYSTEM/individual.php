...
<div class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Data</li>
          ...
          <h2>INDIVIDUAL COUNSELING</h1>
          <div class="py-3"> 
          <button href="index.php" type="button" class="btn btn-primary text-light" data-bs-toggle="modal" data-bs-target="#exampleModal">Start Counceling</button>
          </div>
      ...
      <div class="modal-body ">
          ...
          <div class="mb-3">
            <label for="message-text" class="col-form-label">II. Counseling Plan:</label>
              <div class="mb-3 ps-2 d-flex justify-content-between align-items-center">
                <label for="message-text" class="col-form-label">a. Counseling Approach(es):</label>
                  <div class="dropdown">
